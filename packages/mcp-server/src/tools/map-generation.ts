...
export class MapGenerationTools {
  ...
  async listScenes(input: any): Promise<any> {
    ...
    try {
      ...
      return await this.foundryClient.query('jdr-mcp-bridge.list-scenes', params);
    } catch (error: any) {
  ...
  async switchScene(input: any): Promise<any> {
    ...
    try {
      ...
      return await this.foundryClient.query('jdr-mcp-bridge.switch-scene', params);
    } catch (error: any) {
  ...
  async generateMap(input: any): Promise<any> {
    ...
    try {
      ...
      const response = await this.foundryClient.query('jdr-mcp-bridge.generate-map', params);
      if (response?.error) {
  ...
  async checkMapStatus(input: any): Promise<any> {
    ...
    try {
      ...
      const response = await this.foundryClient.query('jdr-mcp-bridge.check-map-status', {
        job_id: jobId,
      });
      if (response?.error) {
  ...
  async cancelMapJob(input: any): Promise<any> {
    ...
    try {
      ...
      const response = await this.foundryClient.query('jdr-mcp-bridge.cancel-map-job', {
        job_id: jobId,
      });
      if (response?.error) {
